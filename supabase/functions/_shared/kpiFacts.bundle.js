...
var STEPS10 = ["credit_check", "material_status", "sales_bill", "gate_out", "dispatch_confirm"];
...
function travelDeskWorkItems(data, uid, isAdmin) {
  ...
  return buildQueueEntries11(data.trips, stepSla).filter((e) => isAdmin || isMine(e)).map((e) => ({
