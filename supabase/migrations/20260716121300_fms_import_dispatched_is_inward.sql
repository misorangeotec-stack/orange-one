-- Purchase FMS (import) — DISPATCHED goods sit at the INWARD stage.
--
...
begin
  ...
  select exists(select 1 from public.fms_import_pis where po_id = p_po_id and dispatch_status = 'dispatched') into v_dispatched;
