-- ===========================================================================
-- Purchase FMS (procurement) — advances & final payments are recorded against
...
alter table public.fms_purchase_payments add column if not exists pi_remarks text;

drop function if exists public.fms_purchase_record_payment(uuid, text, numeric, uuid, date, text);
