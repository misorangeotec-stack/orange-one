-- ROLLBACK for 20261128122000_kpi1_report_full_weeks.sql — the trend goes back to weeks cut to the
-- period. The function below is kpi_report exactly as 20261128121000_kpi1_facts.sql created it.
