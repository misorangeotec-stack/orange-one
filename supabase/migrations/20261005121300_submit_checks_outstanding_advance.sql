-- ===========================================================================
-- Travel Desk FMS — §11.2 at SUBMIT as well as at disbursement (Phase 5).
--
-- ⚠ THE REFUSAL AT DISBURSEMENT IS THE REAL GATE, BUT IT ARRIVES TOO LATE TO BE
--   KIND. By then the traveller has had the trip approved and has planned around
--   money that is not coming. Checking at submit costs one sentence and gives
--   them the two ways out while it still matters: untick the advance, or settle
--   the old one.
--
-- ⚠ IT REFUSES THE SUBMISSION, IT DOES NOT SILENTLY DROP THE ADVANCE. Quietly
--   clearing the flag would send the trip on with the traveller still expecting
--   a transfer — the one outcome worse than refusing.
--
-- Everything else in this body is 20261005121000's, unchanged.
-- Reversal: re-run 20261005121000's definition of fms_travel_submit_trip.
-- ===========================================================================
