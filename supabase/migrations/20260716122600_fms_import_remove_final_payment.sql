-- ===========================================================================
-- Purchase FMS (import) — remove the Final Payment step. The flow ends at
-- Tally (System Entry).
--
-- Settling the vendor's balance runs on the vendor's credit terms as an accounts
-- activity; it is not a import work-item for the process coordinator to
...
-- fms_import_payments table and this RPC all survive) — they are simply no
...
-- ---------------------------------------------------------------------------
delete from public.fms_import_step_owners where step_key = 'final_payment';
