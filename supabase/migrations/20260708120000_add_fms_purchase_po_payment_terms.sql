-- ===========================================================================
-- Purchase FMS (procurement) — PAYMENT TERMS move from the PI to the PO.
--
...
--
-- Additive only: one new nullable column on fms_purchase_pos + the share_po RPC
...
drop function if exists public.fms_purchase_share_po(uuid, text, text, text, text);
...
grant execute on function public.fms_purchase_share_po(uuid, text, text, text, text, text) to authenticated;
