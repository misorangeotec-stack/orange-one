-- Purchase FMS (import) — PER-PI ADVANCE / PAYMENT.
--
...
-- cap in fms_import_record_payment so that when a p_pi_id is supplied the
...
--
-- Additive / replace-only: no schema change (fms_import_payments.pi_id has
