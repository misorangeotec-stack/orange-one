-- ROLLBACK for 20261127121000_cc1_fms_rank_board_preview.sql — restores the board RPC
-- exactly as 20261127120000_cc1_fms_ranking.sql created it (no "Preview as").

drop function if exists public.fms_rank_board(date, uuid);
