-- ===========================================================================
-- Purchase FMS (procurement) — DISPATCH DATE moves from the PI to the PO, and
...
--
-- Additive only: one new nullable column on fms_purchase_pos (backfilled from the
...
drop function if exists public.fms_purchase_share_po(uuid, text, text, text, text, text);
