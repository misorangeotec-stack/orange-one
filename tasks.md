...
- [x] Mention atomic write done (add_task_remark RPC). _Atomic shift RPC still optional — shift is 2 non-transactional writes (both valid/recoverable); an RPC would make it atomic._
