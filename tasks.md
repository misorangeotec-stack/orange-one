...
- [ ] **Recurring-instance generation (genuinely pending)** — recurring *templates* CRUD is live, but nothing yet materializes task rows from them on schedule (needs a pg_cron / scheduled Edge Function + an approach decision).
