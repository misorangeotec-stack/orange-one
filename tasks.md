...
- [x] RYG weekly plans done. _Realtime bell push (Supabase realtime subscription) not wired — bell refetches on mutation; live push is an optional enhancement._
