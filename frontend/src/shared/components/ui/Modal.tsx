...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className={cn("relative w-full bg-white rounded-card-lg shadow-card border border-line animate-fade-up", width)}>
        ...
        {footer && <div className="flex items-center justify-end gap-2.5 p-5 pt-4">{footer}</div>}
      </div>
    </div>
  );
}
