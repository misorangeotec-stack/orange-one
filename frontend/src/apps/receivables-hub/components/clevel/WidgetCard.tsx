...
/**
 * Identical chrome for every C-Level widget: a tight header (icon + title + optional right slot)
 * over a body that owns its own loading / error / empty states. The page passes the grid
 * column-span via `className` so all widgets share one dense grid.
 */
