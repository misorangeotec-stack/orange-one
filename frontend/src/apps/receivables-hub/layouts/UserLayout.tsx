...
const FY_PINNED_ROUTES = [
  ...
  // The Finance master reports (Receivables / Payables / Income / Expense) each carry their own
  // company + FY picker in the page header, naming the FY and its prior year on every panel — a
  // topbar selector would be a second, disagreeing control over the same thing.
