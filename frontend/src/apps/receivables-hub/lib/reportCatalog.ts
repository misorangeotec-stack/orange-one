...
export const REPORTS: ReportEntry[] = [
  ...
  {
    id: "ink-mis",
    // Item grain, and the ink books are company-wide — a salesperson scope means nothing here.
    scoping: "none",
    title: "Ink MIS",
    purpose:
      "Ink cover across all four books on one line, against the consignments still on the water.",
    category: "inventory",
    path: "reports/ink-mis",
    icon: Droplets,
    source: "tally",
    status: "live",
    keywords: ["ink", "ink mis", "ims", "printing ink", "cover", "reorder", "reorder level",
               "lead time", "safety factor", "consumption", "three month average", "stock cover",
               "eta", "etd", "at port", "shipment", "consignment", "import", "pipeline",
               "combined stock", "four companies"],
  },
  {
    id: "ink-pipeline",
    scoping: "none",
    title: "Ink Pipeline (ETD / ETA)",
    purpose: "Enter and maintain the incoming ink consignments that feed the Ink MIS.",
    category: "inventory",
    path: "reports/ink-pipeline",
    icon: Ship,
    source: "tally",
    status: "live",
    keywords: ["eta", "etd", "at port", "shipment", "consignment", "incoming", "ink pipeline",
               "import", "arrival", "departure", "on the water"],
  },
