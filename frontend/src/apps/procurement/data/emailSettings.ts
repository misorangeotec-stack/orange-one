...
/**
 * Per-module email on/off switch for RM Domestic (module id "procurement"),
 * backed by public.email_module_settings via the admin-checked
 * set_email_module_enabled RPC. The server-side fms_purchase_announce enqueue
 * only fires when this is on.
 */
export const PROCUREMENT_MODULE_ID = "procurement";
