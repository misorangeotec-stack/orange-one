...
export function tallyLockReason(data: ProcSnapshot, t: TallyBooking): string | null {
...
export const completedTallyEntries = (data: ProcSnapshot): StageEntry<TallyBooking>[] =>
