...
export default function Dashboard() {
  ...
  const kpiTiles: KpiTile[] = [
    ...
    { key: "open", label: "Open requisitions", value: openRequests, hint: "not yet closed" },
    { key: "pos", label: "Live POs", value: livePos, hint: "in progress" },
    { key: "delayed", label: "Delayed", value: counts.delayed, hint: "past due", tone: counts.delayed > 0 ? "red" : undefined },
    { key: "closed", label: "Closed (30d)", value: closed30, hint: "booked in Tally" },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <DistributionCard title="Purchase orders by stage" rows={poDist} emptyLabel="No purchase orders yet." />
