...
export const recurringTasks: RecurringTask[] = [
  { id: "r1", title: "Submit daily sales report", description: "Every working day.", recurrenceType: "daily", weeklyDays: [], monthlyDays: [], assignedTo: "u6", createdBy: "u3", departmentId: "d3", active: true, locationIds: [] },
  { id: "r2", title: "Weekly stock update", description: "Every Friday.", recurrenceType: "weekly", weeklyDays: [5], monthlyDays: [], assignedTo: "u6", createdBy: "u3", departmentId: "d3", active: true, locationIds: [] },
  { id: "r3", title: "Weekly cash position report", description: "Every Monday.", recurrenceType: "weekly", weeklyDays: [1], monthlyDays: [], assignedTo: "u7", createdBy: "u4", departmentId: "d2", active: false, locationIds: [] },
  { id: "r4", title: "Monthly expense report", description: "Due on the 1st of each month.", recurrenceType: "monthly", weeklyDays: [], monthlyDays: [1], assignedTo: "u7", createdBy: "u4", departmentId: "d2", active: true, locationIds: [] },
];
