        ...
        canWrite ? undefined : (
          <div className="mb-5 flex items-start gap-3 rounded-card border border-[#F8B62B]/50 bg-[#FEF9EE] px-4 py-3">
            ...
            <p className="text-[12.5px] text-[#9a6e0c] leading-relaxed">
              <b className="font-semibold">Live writes rolling out.</b> Creating tasks, the Start /
              Revise / Complete actions, and rescheduling / shifting to next week now save to the live
              backend. Other edits (remarks, recurring, weekly plans) are being wired next and won't save yet.
            </p>
          </div>
        )
      }
