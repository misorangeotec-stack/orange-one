        ...
        canWrite ? undefined : (
          <div className="mb-5 flex items-start gap-3 rounded-card border border-[#F8B62B]/50 bg-[#FEF9EE] px-4 py-3">
            ...
            <p className="text-[12.5px] text-[#9a6e0c] leading-relaxed">
              <b className="font-semibold">Live writes rolling out.</b> Creating tasks, Start / Revise /
              Complete, rescheduling / shifting to next week, @mention remarks, and recurring-task setup
              now save to the live backend. The rest (weekly plans, admin user/department changes) are
              being wired next and won't save yet.
            </p>
          </div>
        )
      }
