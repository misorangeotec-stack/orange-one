 ...
 * and can hold or cancel an order. Stored in fms_dispatch_config under
  ...
  return (
    <Card className="p-5 space-y-4 max-w-xl">
      <p className="text-[12.5px] text-grey">
        Coordinators oversee the whole order-to-dispatch flow — they can act on any step, hold or cancel an order, and
        open the Control Center.
      </p>
      <MultiSelect
        values={picked}
        onChange={(v) => { setPicked(v); setSaved(false); }}
