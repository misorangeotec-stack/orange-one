 ...
 *
 * ⚠ Until owners are seeded, every gate collapses to "admins only" and the module
 *   looks broken to everyone else. This screen is a go-live step, not an option.
 */
                    ...
                    <td className="px-4 py-3">
                      {names.length ? (
                        ...
                        <span className="text-grey-2">
                          {st.key === "sales_order" ? "Anyone with access may raise" : "Unassigned"}
                        </span>
                      )}
                    </td>
                  </tr>
