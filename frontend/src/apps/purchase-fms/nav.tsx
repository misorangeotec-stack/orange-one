...
export const fmsNav: NavItem[] = [
  ...
  { label: "My Queue", to: `${B}/queue`, icon: ic.queue },
  { label: "All Entries", to: `${B}/entries`, icon: ic.entries },
  { label: "New Order", to: `${B}/entries/new`, icon: ic.newOrder, section: "Actions" },
  { label: "Reports", to: `${B}/reports`, icon: ic.reports, roles: ["admin", "hod", "sub_hod"], section: "Insights" },
