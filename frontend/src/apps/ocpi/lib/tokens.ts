...
export const TOKEN_HELP: { token: string; means: string }[] = [
  ...
  { token: "trade_term", means: "the delivery term as printed, e.g. CIF Nhava Sheva (Under EPCG License) / Ex-Work Surat (Transportation bear by Customer) / Local Delivery Surat" },
