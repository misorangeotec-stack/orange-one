...
/**
 * Per-module email on/off switch for Import (module id "import"), backed by
 * public.email_module_settings via the admin-checked set_email_module_enabled
 * RPC. The server-side fms_import_announce enqueue only fires when this is on.
 */
export const IMPORT_MODULE_ID = "import";
