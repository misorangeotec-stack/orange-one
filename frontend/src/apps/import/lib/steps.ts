 ...
 *
 * Everything in between maps 1:1 — including `advance_payment`, whose DB
 * step_key is unchanged here even though Import re-titles it "Payment".
 * Unknown stages resolve to null rather than throwing, matching how
 * `activeIndex` degrades in PoStepper.
 */
