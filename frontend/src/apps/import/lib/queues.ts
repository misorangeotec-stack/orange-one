...
export const grnTallyDueIso = (data: ImportSnapshot, g: Grn): string | null =>
  afterWorkingDays(g.createdAt, slaFor(data, "tally").days);

/** A receipt's QC inspection: due N working days after its Tally booking. */
export const grnQcDueIso = (idx: ImportIndex, data: ImportSnapshot, g: Grn): string | null =>
...
export const inspectionReturnDueIso = (data: ImportSnapshot, q: QcInspection): string | null =>
...
export const inspectionGateOutDueIso = (data: ImportSnapshot, q: QcInspection): string | null =>
