 ...
 *
 * It renders the FULL Import flow (Request → Approval → Generate PO → Share PO
 * … Tally): for any existing PO the three request-side nodes are already done,
 * so the rail sits somewhere in the PO half. RequestStepper shows the same rail
 * from the request side. Rendering lives in the shared PoStageRail, which the
 * domestic Purchase FMS uses too.
 */
