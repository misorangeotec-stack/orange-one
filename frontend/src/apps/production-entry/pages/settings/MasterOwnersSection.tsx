 ...
 * and resolve its new-entry requests. Leave one unassigned and it falls back to
 * the admins.
 */
export default function MasterOwnersSection() {
  ...
  const open = (mt: ProductionMasterType) => {
  ...
  const save = async () => {
    ...
    try { await s.setMasterManagers(editing, picked); setEditing(null); }
