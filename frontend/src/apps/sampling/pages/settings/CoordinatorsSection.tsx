 ...
 * and can hold requests. Stored in fms_sampling_config under `process_coordinators`.
 */
  ...
  return (
    <Card className="p-5 space-y-4 max-w-xl">
      <p className="text-[12.5px] text-grey">
        Coordinators oversee the whole sampling process — they can act on any step, hold a request, and open the Control
        Center.
      </p>
