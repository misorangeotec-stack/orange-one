...
/**
 * The Sampling Control Center — the SAME queue entries every page counts, bucketed
...
export default function ControlCenter() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-[22px] font-bold text-navy">{appName("sampling")} Control Center</h1>
        <p className="text-[13.5px] text-grey-2 mt-1">Open work across the whole sampling process, by how close it is to its due date.</p>
      </div>
