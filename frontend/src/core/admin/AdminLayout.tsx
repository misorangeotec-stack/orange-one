        ...
        canWrite ? undefined : (
          <div className="mb-5 flex items-start gap-3 rounded-card border border-[#F8B62B]/50 bg-[#FEF9EE] px-4 py-3">
            ...
            <p className="text-[12.5px] text-[#9a6e0c] leading-relaxed">
              <b className="font-semibold">Read-only preview.</b> You're viewing live workspace data.
              Editing users, departments and access is being wired next — changes won't be saved yet.
            </p>
          </div>
        )
      }
